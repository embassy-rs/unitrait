...
fn ui() {
    ...
    // cfg_attr opaque errors.
    t.compile_fail("tests/ui/cfg_attr_bad_opaque.rs");
    t.compile_fail("tests/ui/cfg_attr_unknown_key.rs");
    t.compile_fail("tests/ui/cfg_attr_mixed_bare.rs");
    t.compile_fail("tests/ui/cfg_attr_not_list.rs");
    t.compile_fail("tests/ui/cfg_attr_too_many.rs");
